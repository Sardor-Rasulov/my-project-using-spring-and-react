...
function GetMeatProducts(){
    ...
    const EDIT_PRODUCT_QUANTITY_URL = "http://localhost:8080/api/v1/updateMeatQuantity"
    const GET_ALL_DAIRY = "http://localhost:8080/api/v1/getAllMeat"
    const cutIcon = <FontAwesomeIcon icon="sign-out-alt" />;
...
export default GetMeatProducts